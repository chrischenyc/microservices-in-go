...
import (
	...
	"github.com/chrischenyc/microservices-in-go/ep-08/handlers"
	"github.com/go-openapi/runtime/middleware"
	gorilla_middleware "github.com/gorilla/handlers"
)
...
func main() {
	...
	root.Use(func(next http.Handler) http.Handler {
		return gorilla_middleware.LoggingHandler(os.Stdout, next)
	})
